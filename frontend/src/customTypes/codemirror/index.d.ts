...
declare namespace CodeMirror {
	...
	interface OwnExtension {
		styleActiveLine?: boolean;
	}

	interface EditorConfiguration extends OwnExtension {
        ...
        Most input is captured by events, but some things, like IME activeinput on some browsers, don't generate events that allow CodeMirror to properly detect it.
